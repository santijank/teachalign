...
## คลิปวิดีโอการสอน (ดูจากวิดีโอแนบ):
[วิเคราะห์จากวิดีโอโดยตรง]

## คำสั่งสำคัญเรื่องเวลา:
- actualMinutes = ความยาวจริงของวิดีโอ (duration) ที่แนบมา ดูจากวิดีโอโดยตรง
- plannedMinutes = เวลาที่ระบุในแผนการสอน (ถ้าไม่ระบุให้ใส่ 60)
- คลิปวิดีโอที่ส่งมาโดยปกติจะมีความยาวไม่เกิน 60 นาที
- ห้ามเดาเวลา ต้องดูจาก duration ของวิดีโอจริงเท่านั้น
...

{
  ...
  "timeAlignment": {
    "plannedMinutes": <number ดูจากแผนการสอน ถ้าไม่ระบุให้ใส่ 60>,
    "actualMinutes": <number ดูจากความยาวจริงของวิดีโอ สำคัญ: ต้องดูจาก duration ของวิดีโอที่แนบมาเท่านั้น ห้ามเดา โดยปกติคลิปจะไม่เกิน 60 นาที>,
    "score": <number 0-100 คำนวณจากสัดส่วนเวลาจริง/แผน ยิ่งใกล้กันยิ่งดี>
  },
